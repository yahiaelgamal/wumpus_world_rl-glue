...
public class WumpusWorldRandomAgent_intActions implements AgentInterface {
    ...
    /**
     * In this method, the agent should decide what to do whenever the environment starts.
     * @param observation
     * @return
     */
    ...
    /**
     * In this method, the agent should decide what to do for each step given the 
    ...
    /**
     * This is how you can load the agent and execute it's class through AgentLoader.
     * @param args
     */
    public static void main(String[] args) {
        AgentLoader theLoader = new AgentLoader(new WumpusWorldRandomAgent_intActions());
        theLoader.run();
    }
}
